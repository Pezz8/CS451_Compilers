...
{if ("" != null) return statement;}
  ...
  final private JStatement statement() throws ParseException {int line = 0;
    ...
    ArrayList<JStatement> forI = new ArrayList<JStatement>();
    ArrayList<JStatement> forU = new ArrayList<JStatement>();
    try {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case LCURLY:{
        statement = block();
...
line = token.beginLine;
        ...
        body = statement();
statement = new JForStatement(line, forI, expr, forU, body);
        break;
        }
      case WHILE:{
        jj_consume_token(WHILE);
...
// Project 4 Problem 9
/**
 * Parses a forInit statement and returns an AST for it.
 *
 * <pre>
 ...
 * </pre>
 *
 * @return an AST for a forInit expression.
 */
  final public ArrayList<JStatement> forInit() throws ParseException {ArrayList<JStatement> statements = new ArrayList<JStatement>();
    JStatement aStatement = null;
    int line = token.beginLine;
    ArrayList <JVariableDeclarator> declarators = new ArrayList<JVariableDeclarator>();
    Type type = null;
    try {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
      case FALSE:
...
/**
 * Parses a forUpdate statement and returns an AST for it.
 *
 * <pre>
 *   forUpdate ::= statementExpression { COMMA statementExpression }
 * </pre>
 *
 * @return an AST for a forUpdate expression.
 */
  final public ArrayList<JStatement> forUpdate() throws ParseException {ArrayList<JStatement> statements = new ArrayList<JStatement>();
    JStatement aStatement = null;
    int line = token.beginLine;
    try {
  ...
  private boolean jj_3R_45()
 {
  ...
  static {
	...
	private static void jj_la1_init_0() {
	   jj_la1_0 = new int[] {0x2000000,0x100000,0x5c009000,0x5c001000,0x5c001000,0x20000,0x5c407000,0x406000,0x0,0x406000,0xa1cc6000,0xa18c0000,0x81840000,0xa1cc6000,0x81840000,0x81840000,0xa18c0000,0x0,0xa1cc6000,0x0,0x0,0x406000,0x0,0x0,0x81840000,0x0,0x81840000,0x0,0x81840000,0x406000,0x406000,0x0,0x0,0x406000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x200000,0x200000,0x0,0x0,0x0,0x0,0x0,0x0,0x81840000,0x0,0x81840000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x81840000,0x406000,0x0,0x0,0x0,0x1040000,};
	}
	private static void jj_la1_init_1() {
	   jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x8404,0x8404,0x10800000,0x8400,0x5180969b,0x5180129b,0x41000003,0x5180969b,0x41000003,0x41000003,0x5180129b,0x100000,0x5180969b,0x100000,0x100000,0x8400,0x100000,0x20000000,0x41800003,0x100000,0x41800003,0x100000,0x41000003,0x8400,0x8400,0x400000,0x400000,0x8400,0x20000000,0x20000000,0x0,0x0,0x0,0x0,0x0,0x0,0x80000000,0x80000000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x41000003,0x0,0x1000003,0x600000,0x40000000,0x0,0x1000000,0x600000,0x1000000,0x1000000,0x1200000,0x1000000,0x1000003,0x8400,0x800000,0x1000000,0x400000,0x2,};
	}
	private static void jj_la1_init_2() {
	   jj_la1_2 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x1000072,0x1000072,0x1000072,0x1000072,0x1000072,0x1000072,0x1000072,0x0,0x1000072,0x0,0x0,0x0,0x0,0x0,0x1000072,0x0,0x1000072,0x0,0x1000072,0x0,0x0,0x0,0x0,0x0,0xc8c24c80,0xc8c24c80,0x10000000,0x100000,0x4,0x4000000,0x0,0x1000,0x2000000,0x2000000,0xc0009,0xc0009,0x202200,0x202200,0x60,0x60,0x20010100,0x20010100,0x1000072,0x1000010,0x0,0x0,0x0,0x2,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
	}
	private static void jj_la1_init_3() {
	   jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x4,0x4,0x0,0x4,0x3704,0x3704,0x3704,0x3704,0x3704,0x3704,0x3704,0x0,0x3704,0x0,0x0,0x4,0x0,0x0,0x3704,0x0,0x3704,0x0,0x3704,0x0,0x0,0x0,0x0,0x4,0x2,0x2,0x0,0x0,0x0,0x0,0x1,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3704,0x0,0x3704,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x3704,0x4,0x0,0x0,0x0,0x3700,};
	}
